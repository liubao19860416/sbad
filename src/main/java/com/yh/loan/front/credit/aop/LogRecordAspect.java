...
import com.yh.loan.front.credit.config.MessageSourceUtil;
import com.yh.loan.front.credit.controller.vo.ResultInfo;
...
import com.yh.loan.front.credit.utils.CommonUtils;
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if(!"post".equalsIgnoreCase(request.getMethod())){
            ...
            if(LOGGER.isInfoEnabled()){
                LOGGER.info("##########################################################");
                LOGGER.info("########@@Around request url: {}" , url);
        ...
        jsonString = JSON.toJSONString(retValue, true);
