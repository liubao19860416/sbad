...
@Configuration
@EnableScheduling
@ConditionalOnProperty(/*prefix="spring.scheduler",*/name={"spring.scheduler.poolSize","spring.scheduler.awaitTerminationSeconds","spring.task.corePoolSize","spring.task.maxPoolSize","spring.task.queueCapacity","spring.task.keepAliveSeconds"})
//@ComponentScan(basePackages = "com.yh.loan.front.credit.task")
